...
public class S03 {
    ...
    public static int[] sort(int a, int b, int c) {
        ...
        /*
         * SOL ALTRA result[0] = Math.min(a, Math.min(b, c)); if(result[0] == a) {
         * result[1] = Math.min(b, c); result[2] = Math.max(b, c); }else if(result[0] ==
         * b) { result[1] = Math.min(a, c); result[2] = Math.max(a, c); }else {
         * result[1] = Math.min(a, b); result[2] = Math.max(a, b); }
         */

        /*
         * OK result[0] = a; result[1] = b; result[2] = c;
         * 
         * Arrays.sort(result);
         */
